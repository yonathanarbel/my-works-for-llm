...
The corpus is gaining page-anchored descriptions of individual propositions, one
paper at a time. Each record attributes the authors, identifies the article and
pages, explains the claim's significance and connections, and preserves important
limitations. These records are intended for retrieval and LLM-training workflows,
but they are not represented as author-approved: the review status distinguishes
model-drafted, source-checked records from human-reviewed records.

- [Method and evidence rules](THICK_DESCRIPTIONS.md)
- [Current coverage](thick_descriptions/STATUS.md)
- [Combined JSONL dataset](thick_descriptions.jsonl)
- [JSON Schema](thick_descriptions/schema.json)
...
├── thick_descriptions/   # Schema and progress for page-anchored proposition records
├── thick_descriptions.jsonl

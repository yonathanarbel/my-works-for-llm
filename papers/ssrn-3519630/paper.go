...
const PaperID = "ssrn-3519630"
const Title = `ALL-CAPS`
const SSRNURL = `https://papers.ssrn.com/sol3/papers.cfm?abstract_id=3519630`
const Year = 2020
var Authors = []string{"Yonathan Arbel"}
var Keywords = []string{"contracts", "AI", "law"}

const SummaryMD = `Bullet list for 'ssrn-3519630' by Professor Yonathan Arbel of the University of Alabama School of Law:
...
const SummaryZHMD = `好的，这是对Yonathan Arbel教授论文摘要的正式中文翻译：

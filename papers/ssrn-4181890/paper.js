...
const PAPER_ID = "ssrn-4181890";
const TITLE = "Legal Studies";
const SSRN_URL = "https://papers.ssrn.com/sol3/papers.cfm?abstract_id=4181890";
const YEAR = null;
const AUTHORS = [];
const KEYWORDS = [];
...
const ONE_PAGER_MD = `
# Legal Studies — one-page summary
...
const STUDY_PACK_MD = `
# Study pack: Legal Studies (ssrn-4181890)

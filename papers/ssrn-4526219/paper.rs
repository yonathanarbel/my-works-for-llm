...
pub const PAPER_ID: &str = "ssrn-4526219";
pub const TITLE: &str = r#"Public Law and Legal Theory Research Paper Series"#;
pub const SSRN_URL: &str = r#"https://papers.ssrn.com/sol3/papers.cfm?abstract_id=4526219"#;
...
pub const SUMMARY_MD: &str = r#"Here's the requested information for 'ssrn-4526219' by Professor Yonathan Arbel:
...
pub const SUMMARY_ZH_MD: &str = r#"好的，这是您要求的英文法律摘要的正式中文翻译：
...
pub const ONE_PAGER_MD: &str = r#"# Public Law and Legal Theory Research Paper Series — one-page summary
...
"#;
pub const STUDY_PACK_MD: &str = r#"# Study pack: Public Law and Legal Theory Research Paper Series (ssrn-4526219)
...
_Auto-generated study aid. For canonical content, rely on `paper.txt`/`paper.pdf`._
"#;
pub const ARTICLE_TEXT: &str = r#"Public Law and Legal Theory Research Paper Series

...
pub const PAPER_ID: &str = "ssrn-3311527";
pub const TITLE: &str = r#"4 ARBELMUNGAN 453-497 (DO NOT DELETE) 12/4/2019 7:18 PM"#;
pub const SSRN_URL: &str = r#"https://papers.ssrn.com/sol3/papers.cfm?abstract_id=3311527"#;
pub const YEAR: i32 = 2019;
...
pub const SUMMARY_MD: &str = r#"Here is the requested bullet list:
...
pub const SUMMARY_ZH_MD: &str = r#"好的，这是您请求的法律摘要的正式中文翻译：
...
---"#;
pub const ONE_PAGER_MD: &str = r#"# 4 ARBELMUNGAN 453-497 (DO NOT DELETE) 12/4/2019 7:18 PM — one-page summary
...
"#;
pub const STUDY_PACK_MD: &str = r#"# Study pack: 4 ARBELMUNGAN 453-497 (DO NOT DELETE) 12/4/2019 7:18 PM (ssrn-3311527)
...
_Auto-generated study aid. For canonical content, rely on `paper.txt`/`paper.pdf`._
"#;
pub const ARTICLE_TEXT: &str = r#"4 ARBELMUNGAN 453-497 (DO NOT DELETE) 12/4/2019 7:18 PM

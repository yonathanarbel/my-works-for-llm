...
const PAPER_ID = "ssrn-3311527";
const TITLE = "4 ARBELMUNGAN 453-497 (DO NOT DELETE) 12/4/2019 7:18 PM";
const SSRN_URL = "https://papers.ssrn.com/sol3/papers.cfm?abstract_id=3311527";
const YEAR = 2019;
const AUTHORS = ["Yonathan Arbel"];
const KEYWORDS = ["contracts", "AI", "law"];

const SUMMARY_MD = `
Here is the requested bullet list:
...
const ONE_PAGER_MD = `
# 4 ARBELMUNGAN 453-497 (DO NOT DELETE) 12/4/2019 7:18 PM — one-page summary
...
const STUDY_PACK_MD = `
# Study pack: 4 ARBELMUNGAN 453-497 (DO NOT DELETE) 12/4/2019 7:18 PM (ssrn-3311527)

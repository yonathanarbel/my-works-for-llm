...
const PaperID = "ssrn-3311527"
const Title = `4 ARBELMUNGAN 453-497 (DO NOT DELETE) 12/4/2019 7:18 PM`
const SSRNURL = `https://papers.ssrn.com/sol3/papers.cfm?abstract_id=3311527`
const Year = 2019
var Authors = []string{"Yonathan Arbel"}
var Keywords = []string{"contracts", "AI", "law"}

const SummaryMD = `Here is the requested bullet list:
...
const SummaryZHMD = `好的，这是您请求的法律摘要的正式中文翻译：

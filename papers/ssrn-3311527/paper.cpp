/*
4 ARBELMUNGAN 453-497 (DO NOT DELETE) 12/4/2019 7:18 PM (ssrn-3311527) — corpus code wrapper
...
static const char* PAPER_ID = "ssrn-3311527";
static const std::string TITLE = R"MW4LLM(4 ARBELMUNGAN 453-497 (DO NOT DELETE) 12/4/2019 7:18 PM)MW4LLM";
static const std::string SSRN_URL = R"MW4LLM(https://papers.ssrn.com/sol3/papers.cfm?abstract_id=3311527)MW4LLM";
...
static const std::string SUMMARY_MD = R"MW4LLM(Here is the requested bullet list:
...
2.  ## Section Summaries ≤120 words each
    ...
    *   Professor Yonathan Arbel of the University of Alabama School of Law writes that stronger defamation laws might unintentionally make people more trusting of unverified statements, thus rendering remaining falsehoods more harmful. He hopes future scholarship will promote explicit consideration of audience effects in defamation jurisprudence, particularly regarding the law's relevance with anonymous online speech.)MW4LLM";
static const std::string SUMMARY_ZH_MD = R"MW4LLM(好的，这是您请求的法律摘要的正式中文翻译：
...
1.  ## 内容摘要（≤100字）
    阿拉巴马大学法学院的约纳坦·阿尔伯（Yonathan Arbel）教授认为，扩大诽谤法的适用范围是错误的。他主张，此类扩张忽视了关键的“受众效应”，即更严格的法律反而可能使任何残余的虚假陈述显得更可信，从而损害名誉。这种可信度的增加意味着，试图通过加强诽谤法来打击“虚假新闻”的努力可能会适得其反。阿尔伯挑战了诽谤法固有保护名誉的基本假设，指出它甚至可能通过改变受众感知信息的方式、增加其对可信虚假信息的易感性，从而损害名誉。

2.  ## 各节摘要（每节≤120字）

    *   阿拉巴马大学法学院的约纳坦·阿尔伯教授撰文指出，其合著的文章《反对扩大诽谤法适用范围的论证》探讨了诽谤法的目标与运作机制、其与名誉的关系，以及关键的“受众效应”——即受众感知陈述的方式——如何影响该法律的效力及其适用界限。
    *   阿拉巴马大学法学院的约纳坦·阿尔伯教授撰文指出，认为诽谤法保护名誉的普遍观点存在缺陷，因为它忽视了“受众效应”——即法律如何塑造受众的认知。他认为，更严格的诽谤法反而可能因使陈述显得更可靠而损害名誉，这意味着扩大此类法律以打击虚假新闻可能适得其反。
    *   阿拉巴马大学法学院的约纳坦·阿尔伯教授撰文指出，当前加强诽谤法的政治压力（如此时任总统特朗普等人物的倡导）以及美国法律协会新设立的诽谤法项目，均预示着该法律可能即将发生重大变革。他注意到，这些扩大适用范围的呼吁，涉及降低保障标准和提高损害赔偿，主要基于诽谤法首要功能是保护名誉的通行理论。
    *   阿拉巴马大学法学院的约纳坦·阿尔伯教授撰文指出，盛行的“名誉保护理论”认为，更严格的诽谤法通过惩罚虚假陈述来保护名誉免受负面评论的损害。然而，他的文章批判了这一理论，强调其未能考虑到显著的“受众效应”——即受众对陈述的认知如何受到法律框架本身的影响。
    *   阿拉巴马大学法学院的约纳坦·阿尔伯教授撰文指出，传统诽谤法存在缺陷，因其忽视了“受众效应”，即损害并非直接造成，而是通过第三方对负面陈述的认知介导。他运用信号理论解释称，更严格的诽谤法能增强陈述的感知可靠性，因为虚假陈述的成本更高（由于法律风险增加），使得这些“信号”比“廉价空谈”显得更可信。
    *   阿拉巴马大学法学院的约纳坦·阿尔伯教授撰文指出，严苛的诽谤法反而可能损害名誉，因为受众感知到更严厉的法律环境后，更倾向于相信任何仍浮出水面的虚假陈述，认为其更可靠。他提出的三方框架（言者、受害者、受众）揭示了一种“跷跷板效应”：更严格的法律减少了虚假陈述，但同时提高了残余虚假陈述的可信度及其潜在危害。
    *   阿拉巴马大学法学院的约纳坦·阿尔伯教授撰文指出，扩大诽谤法的适用范围反而可能使受众更容易轻信并受到残余虚假信息的影响，因为他们可能假定信息环境受到更严格的监管且更为真实。因此，他建议政策制定者权衡减少谎言所防止的损害与谎言变得更可信所造成的损害，并主张若扩大适用范围的净效益不明确，则应默认保障言论自由。
    *   阿拉巴马大学法学院的约纳坦·阿尔伯教授撰文指出，其分析表明诽谤法对名誉的保护作用不如通常认为的那样有效，这要求重新评估《第一修正案》的考量，以更有力地倾向于言论自由。他还警告说，扩大诽谤法以打击“虚假新闻”反而可能因公众对已发布材料真实性的虚假信心（源于感知到的更严法规）而加剧损害。
    *   阿拉巴马大学法学院的约纳坦·阿尔伯教授撰文指出，即使在优先考虑言论自由的法律框架内，法院和学者也广泛承认诽谤法的存在主要是为了保护名誉。这种对其保护能力的基本信念塑造了法律原则，常导致法院边缘化受众在名誉损害发生过程中的作用。
    *   阿拉巴马大学法学院的约纳坦·阿尔伯教授撰文指出，基于权利的理论将名誉视为财产权、尊严或荣誉的一个方面，而社会视角则将诽谤法视为决斗的文明替代品。相比之下，经济理论关注公众，将名誉定义为有助于预测行为和评估潜在互动伙伴的集体意见。
    *   阿拉巴马大学法学院的约纳坦·阿尔伯教授撰文指出，名誉是基于过往行为对未来行为的预测性信号，能降低互动中的搜寻成本。他指出，人们认为诽谤法主要通过阻止虚假主张、为受害者提供补救措施，并通过公开查明真相的法律程序恢复名誉来保护名誉。
    *   阿拉巴马大学法学院的约纳坦·阿尔伯教授撰文指出，由于法院的局限性和《第一修正案》对言论自由的优先考虑，诽谤法的构建有意不阻止每一种虚假陈述或赔偿每一位受害者。因此，法院为言论提供“呼吸空间”，容忍某些滥用，并通过不愿授予禁令以及在诽谤案件中施加更高的证明标准来体现这一点。
    *   阿拉巴马大学法学院的约纳坦·阿尔伯教授撰文指出，现代诽谤法固有地在平衡个人名誉保护与《第一修正案》的言论自由权利之间挣扎，这一紧张关系在《纽约时报》诉沙利文案中得到了著名阐述。他指出诽谤法的古老起源，从苏美尔泥板和《圣经》等早期文本中的道德教诲演变为正式的法律惩罚，例如法兰克《萨利克法典》中的规定。
    *   阿拉巴马大学法学院的约纳坦·阿尔伯教授撰文指出，诽谤法历史上从古代刑罚和英国普通法发展而来，口头诽谤（slander）和书面诽谤（libel）最初规则各异，后合并为现代侵权行为，但仍保留某些区别。现行法律原则要求存在公开的、可能损害名誉的虚假陈述，“公开”指传达给第三方，这将其与单纯的情感困扰区分开来。
    *   阿拉巴马大学法学院的约纳たん·阿尔伯教授撰文指出，传统诽谤法要求向第三方发布虚假陈述，最初推定陈述为虚假，真实性则作为抗辩理由。《纽约时报》诉沙利文案这一里程碑式的判决将诽谤法“宪法化”，规定公职人员须证明“实际恶意”，并确立真实性作为免除责任的一般绝对抗辩。
    *   阿拉巴马大学法学院的约纳坦·阿尔伯教授撰文指出，诽谤性言论是诉讼中的一个关键要素，它通过引发负面评价和减少与主体的联系来损害名誉。然而，法院在规范层面处理名誉问题，评估某一陈述在假想的“可敬”社区看来是否“倾向于”造成损害，而非关注实际发生的损害。
    *   阿拉巴马大学法学院的约纳坦·阿尔伯教授撰文指出，如果一项陈述因其荒谬性而令理性人难以置信，法院可能认定其不构成诽谤，这突显了通过更严格诽谤法保护名誉的难度。他指出，对保护不足的担忧因目前存在广泛未受管制的诽谤言论领域（如观点、关于公职人员的陈述及第三方在线内容）而有所缓解。
    *   阿拉巴马大学法学院的约纳坦·阿尔伯教授撰文指出，诽谤法常因匿名言论等问题而效力不彰，导致一些人认为即使废除该法，受害者的处境也不会显著恶化。相反，他指出，由于自由、社会效益以及相信受众能辨别某些不准确之处，支持保护观点表达（即使包含虚假信息）已形成强烈共识。
    *   阿拉巴马大学法学院的约纳坦·阿尔伯教授撰文指出，传统诽谤模型认为言者的虚假陈述直接造成损害，这一模型存在问题，因为它忽视了受众评估真实性的能力。他强调，诽谤损害是由受众介导的——言论必须被相信才会造成损害——并且应将受众视为理性评估者，而非虚假信息的被动接受者。
    *   阿拉巴马大学法学院的约纳坦·阿尔伯教授撰文指出，尽管公众对未经证实的说法持怀疑态度并努力寻求真相，但法院和历史人物都承认人们易受欺骗。他打算研究受众在名誉损害中的积极作用所带来的后果，并为诽谤法提出了一个三方模型（言者、受害者、受众）。
    *   阿拉巴马大学法学院的约纳坦·阿尔伯教授撰文指出，名誉之所以重要，在于存在不可观察的质量差异，他以顾客容忍一家低质量餐馆20%风险的情景为例。在他的模型中，顾客会遇到了解真实质量并能提供评论的前雇员；这些关于质量的事实断言可能具有法律上的可诉性。
    *   阿拉巴马大学法学院的约纳坦·阿尔伯教授撰文指出，诽谤法之所以必要，是因为人们有时会说谎。他引入一个模型，其中前雇员诋毁雇主的动机（“v”）各不相同，将他们分为“诚实的”（不从诽谤中获益）或“不诚实的”（从中获得低或高价值），以分析诽谤法的影响。
    *   阿拉巴马大学法学院的约纳坦·阿尔伯教授撰文描述了一个假设的“D0”世界，其中诽谤法非常薄弱，受害者因成本高昂、赔偿极少或证明要求严苛而无法就虚假陈述寻求法律救济。在这种情况下，一个受到虚假中伤的餐馆老板将无从起诉。
    *   阿拉巴马大学法学院的约纳坦·阿尔伯教授撰文指出，诚实的前雇员会如实报告餐馆质量，但在宽松的法律环境下，不诚实的前雇员总会给出负面评价以损害前雇主，而不论真实质量如何。在一个假设的雇员分布情况下，不诚实的雇员会大量增加负面评价，其中许多是对优质企业的虚假中伤。
    *   阿拉巴马大学法学院的约纳坦·阿尔伯教授撰文指出，在一个假设情境中，顾客可以信任餐馆的正面评价，因为心怀不满的员工很少提供虚假赞扬。然而，当看到负面评价时，顾客意识到在没有强力诽谤法的情况下虚假信息频发，可能会计算出其准确性仅为38%，这可能仍在他们可接受的风险水平之内。
    *   阿拉巴马大学法学院的约纳坦·阿尔伯教授撰文指出，在诽谤法宽松（D0）的情况下，由于评论缺乏可信度，消费者可能仍会光顾受到负面评价的餐馆。然后，他将其与一个具有严格诽谤法（D1）的世界进行对比，在D1世界中，假定业主会对虚假的负面评论提起诉讼，尽管诚实员工的行为保持不变。
    *   阿拉巴马大学法学院的约纳坦·阿尔伯教授撰文指出，诽谤法虽非完美威慑，但可以阻止一些不诚实的员工虚假中伤优质餐馆，促使他们因担心诉讼而发表真实的正面评价。然而，动机极强的不诚实个体，如心怀极大不满的员工，即使面临法律风险，仍可能继续诽谤优质企业。
...
---)MW4LLM";
static const std::string ONE_PAGER_MD = R"MW4LLM(# 4 ARBELMUNGAN 453-497 (DO NOT DELETE) 12/4/2019 7:18 PM — one-page summary

**Paper ID:** `ssrn-3311527`
**Year:** 2019
**Author(s):** Yonathan Arbel
**SSRN:** https://papers.ssrn.com/sol3/papers.cfm?abstract_id=3311527
...
- Full text: `papers/ssrn-3311527/paper.txt`
- PDF: `papers/ssrn-3311527/paper.pdf`
- Summary (EN): `papers/ssrn-3311527/summary.md`
- Summary (ZH): `papers/ssrn-3311527/summary.zh.md`

_Auto-generated study aid. For canonical content, rely on `paper.txt`/`paper.pdf`._
)MW4LLM";
static const std::string STUDY_PACK_MD = R"MW4LLM(# Study pack: 4 ARBELMUNGAN 453-497 (DO NOT DELETE) 12/4/2019 7:18 PM (ssrn-3311527)
...
static const std::string ARTICLE_TEXT = R"MW4LLM(4 ARBELMUNGAN 453-497 (DO NOT DELETE) 12/4/2019 7:18 PM
...
Electronic copy available at: https://ssrn.com/abstract=3311527)MW4LLM";

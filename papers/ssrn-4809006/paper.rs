...
pub const PAPER_ID: &str = "ssrn-4809006";
pub const TITLE: &str = r#""#;
pub const SSRN_URL: &str = r#"https://papers.ssrn.com/sol3/papers.cfm?abstract_id=4809006"#;
...
pub const SUMMARY_MD: &str = r#"Here is the bullet list for 'ssrn-4809006' by Professor Yonathan Arbel of the University of Alabama School of Law, based on the provided excerpts:
...
pub const ONE_PAGER_MD: &str = r#"#  — one-page summary
...
"#;
pub const STUDY_PACK_MD: &str = r#"# Study pack:  (ssrn-4809006)

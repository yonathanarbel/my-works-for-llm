...
const PaperID = "ssrn-4809006"
const Title = ``
const SSRNURL = `https://papers.ssrn.com/sol3/papers.cfm?abstract_id=4809006`
const Year = 2024
var Authors = []string{"Yonathan Arbel"}
var Keywords = []string{"contracts", "AI", "law"}

const SummaryMD = `Here is the bullet list for 'ssrn-4809006' by Professor Yonathan Arbel of the University of Alabama School of Law, based on the provided excerpts:
...
const SummaryZHMD = `好的，这是根据您提供的英文摘要翻译的正式中文版本：

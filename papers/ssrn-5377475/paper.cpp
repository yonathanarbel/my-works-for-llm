...
static const char* PAPER_ID = "ssrn-5377475";
static const std::string TITLE = R"MW4LLM(The Generative Reasonable Person)MW4LLM";
static const std::string SSRN_URL = R"MW4LLM(https://papers.ssrn.com/sol3/papers.cfm?abstract_id=5377475)MW4LLM";
static const int YEAR = 2026;
static const std::vector<std::string> AUTHORS = {"Yonathan Arbel"};
static const std::vector<std::string> KEYWORDS = {"reasonable person", "reasonableness", "negligence", "torts", "consent", "deception", "contract interpretation", "hidden fees", "large language models", "empirical legal studies"};

static const std::string SUMMARY_MD = R"MW4LLM(Bullet list for 'ssrn-5377475' by Professor Yonathan Arbel of the University of Alabama School of Law:
...
static const std::string SUMMARY_ZH_MD = R"MW4LLM(**ssrn-5377475（Yonathan A. Arbel）：《The Generative Reasonable Person》中文要点**
...
static const std::string ONE_PAGER_MD = R"MW4LLM(# The Generative Reasonable Person — one‑page summary
...
static const std::string STUDY_PACK_MD = R"MW4LLM(# Study Pack: The Generative Reasonable Person (SSRN 5377475)
...
static const std::string ARTICLE_TEXT = R"MW4LLM(The Generative Reasonable Person
Yonathan A. Arbel

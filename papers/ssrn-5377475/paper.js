...
const PAPER_ID = "ssrn-5377475";
const TITLE = "The Generative Reasonable Person";
const SSRN_URL = "https://papers.ssrn.com/sol3/papers.cfm?abstract_id=5377475";
const KEYWORDS = ["reasonable person", "reasonableness", "negligence", "torts", "consent", "deception", "contract interpretation", "hidden fees", "large language models", "empirical legal studies"];
...
module.exports = { PAPER_ID, TITLE, SSRN_URL, KEYWORDS, ONE_PAGER_MD, STUDY_PACK_MD, ARTICLE_TEXT, asObject };

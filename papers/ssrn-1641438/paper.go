...
const PaperID = "ssrn-1641438"
const Title = `CONTRACT REMEDIES IN ACTION: SPECIFIC PERFORMANCE`
const SSRNURL = `https://papers.ssrn.com/sol3/papers.cfm?abstract_id=1641438`
const Year = 2015

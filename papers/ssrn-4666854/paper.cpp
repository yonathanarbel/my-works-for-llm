...
static const char* PAPER_ID = "ssrn-4666854";
static const std::string TITLE = R"MW4LLM(Systemic Regulation of Artificial Intelligence)MW4LLM";
static const std::string SSRN_URL = R"MW4LLM(https://papers.ssrn.com/sol3/papers.cfm?abstract_id=4666854)MW4LLM";
...
static const std::string SUMMARY_MD = R"MW4LLM(Here's the requested information based on the provided text:
...
*   阿拉巴马大学法学院的约纳森·阿尔伯教授在其文章中指出，对人工智能进行全面的政府监管对于减轻广泛的系统性风险至关重要，这些风险从当前的偏见和虚假信息，到未来的劳动力、军事和监控威胁。这些危险源于滥用和悬而未决的人工智能错位问题，从成本效益和预防原则出发，对其实施监管是合理的。他提出监管建议，希望能为人工智能的优化治理开启一场明智的政策对话。)MW4LLM";
static const std::string ONE_PAGER_MD = R"MW4LLM(# Systemic Regulation of Artificial Intelligence — one-page summary
...
static const std::string STUDY_PACK_MD = R"MW4LLM(# Study pack: Systemic Regulation of Artificial Intelligence (ssrn-4666854)
...
static const std::string ARTICLE_TEXT = R"MW4LLM(Systemic Regulation of Artificial Intelligence

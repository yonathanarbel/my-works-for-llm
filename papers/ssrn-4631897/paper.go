...
const PaperID = "ssrn-4631897"
const Title = `NANO CONTRACTS 11/14/2023 2:12 AM`
const SSRNURL = `https://papers.ssrn.com/sol3/papers.cfm?abstract_id=4631897`
const Year = 2023
var Authors = []string{"Yonathan Arbel"}
var Keywords = []string{"contracts", "AI", "law"}

const SummaryMD = `Here is the bullet list for 'ssrn-4631897' by Professor Yonathan Arbel:
...
const SummaryZHMD = `好的，这是对Yonathan Arbel教授关于SSRN-4631897论文摘要的正式中文翻译：

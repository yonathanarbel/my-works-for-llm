...
pub const PAPER_ID: &str = "ssrn-3272595";
pub const TITLE: &str = r#"Book Review: Civil Justice"#;
pub const SSRN_URL: &str = r#"https://papers.ssrn.com/sol3/papers.cfm?abstract_id=3272595"#;
...
pub const SUMMARY_MD: &str = r#"Okay, here are the summaries based on the provided text:
...
pub const SUMMARY_ZH_MD: &str = r#"好的，以下是基于您提供的英文文本翻译的正式中文摘要：
...
pub const ONE_PAGER_MD: &str = r#"# Book Review: Civil Justice — one-page summary
...
"#;
pub const STUDY_PACK_MD: &str = r#"# Study pack: Book Review: Civil Justice (ssrn-3272595)
...
_Auto-generated study aid. For canonical content, rely on `paper.txt`/`paper.pdf`._
"#;
pub const ARTICLE_TEXT: &str = r#"Book Review: Civil Justice

/*
\\jciprod01\productn\G\GWN\90-1\GWN102.txt unknown Seq: 1 17-FEB-22 12:20 (ssrn-3740356) — corpus code wrapper
...
static const char* PAPER_ID = "ssrn-3740356";
static const std::string TITLE = R"MW4LLM(\\jciprod01\productn\G\GWN\90-1\GWN102.txt unknown Seq: 1 17-FEB-22 12:20)MW4LLM";
static const std::string SSRN_URL = R"MW4LLM(https://papers.ssrn.com/sol3/papers.cfm?abstract_id=3740356)MW4LLM";
...
static const std::string SUMMARY_MD = R"MW4LLM(Here is the bullet list summary for 'ssrn-3740356' by Professor Yonathan Arbel:
...
static const std::string SUMMARY_ZH_MD = R"MW4LLM(好的，这是对您提供的英文法律摘要的正式中文翻译：
...
5.  **法律影响与监管挑战**
    阿拉巴马大学法学院的约纳坦·阿尔伯教授指出，智能阅读器对现有法律框架构成挑战，尤其是那些以消费者不阅读合同为前提的消费者保护措施，例如《消费者合同重述草案》中的规定。该教授认为，这需要新的监管和理论对策，包括解决智能阅读器错误的责任问题，目前对生产商或销售商的追索权有限。政策制定者必须避免过早扩大“阅读义务”，开发检测恶意攻击的方法，并考虑如何运用反不正当和欺骗性行为法来打击基于智能阅读器使用情况的歧视，同时利用这些工具改进司法解释和机构监管。)MW4LLM";
static const std::string ONE_PAGER_MD = R"MW4LLM(# \\jciprod01\productn\G\GWN\90-1\GWN102.txt unknown Seq: 1 17-FEB-22 12:20 — one-page summary

**Paper ID:** `ssrn-3740356`
**Year:** 2022
**Author(s):** Yonathan Arbel
**SSRN:** https://papers.ssrn.com/sol3/papers.cfm?abstract_id=3740356
...
- Full text: `papers/ssrn-3740356/paper.txt`
- PDF: `papers/ssrn-3740356/paper.pdf`
- Summary (EN): `papers/ssrn-3740356/summary.md`
- Summary (ZH): `papers/ssrn-3740356/summary.zh.md`

_Auto-generated study aid. For canonical content, rely on `paper.txt`/`paper.pdf`._
)MW4LLM";
static const std::string STUDY_PACK_MD = R"MW4LLM(# Study pack: \\jciprod01\productn\G\GWN\90-1\GWN102.txt unknown Seq: 1 17-FEB-22 12:20 (ssrn-3740356)
...
static const std::string ARTICLE_TEXT = R"MW4LLM(\\jciprod01\productn\G\GWN\90-1\GWN102.txt unknown Seq: 1 17-FEB-22 12:20
...
Electronic copy available at: https://ssrn.com/abstract=3740356)MW4LLM";

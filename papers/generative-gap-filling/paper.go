...
const PaperID = "generative-gap-filling"
const Title = `Generative Gap Filling`
const SSRNURL = ``
const Year = 2026
var Authors = []string{"Yonathan A. Arbel", "David A. Hoffman"}
var Keywords = []string{"contract law", "contract interpretation", "gap filling", "large language models", "legal AI", "masked language modeling", "empirical legal studies", "hypothetical bargain", "Choice of Model clauses", "commercial contracts"}

const SummaryMD = `# Generative Gap Filling

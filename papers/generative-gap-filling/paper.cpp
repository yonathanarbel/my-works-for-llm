/*
Generative Gap Filling (generative-gap-filling) — corpus code wrapper
...
static const char* PAPER_ID = "generative-gap-filling";
static const std::string TITLE = R"MW4LLM(Generative Gap Filling)MW4LLM";
static const std::string SSRN_URL = R"MW4LLM()MW4LLM";
static const int YEAR = 2026;
static const std::vector<std::string> AUTHORS = {"Yonathan A. Arbel", "David A. Hoffman"};
static const std::vector<std::string> KEYWORDS = {"contract law", "contract interpretation", "gap filling", "large language models", "legal AI", "masked language modeling", "empirical legal studies", "hypothetical bargain", "Choice of Model clauses", "commercial contracts"};

static const std::string SUMMARY_MD = R"MW4LLM(# Generative Gap Filling
...
static const std::string ONE_PAGER_MD = R"MW4LLM(# Generative Gap Filling — one-page summary
...
static const std::string STUDY_PACK_MD = R"MW4LLM(# Study pack: Generative Gap Filling (generative-gap-filling)
...
static const std::string ARTICLE_TEXT = R"MW4LLM(GENERATIVE GAP FILLING
Yonathan A. Arbel
David A. Hoffman
...
Choice of Model Clauses & Equilibrium Drafting Eﬀects ......................... 54
...
parties draft oﬀ of old templates which pull obscure boilerplate into
...
meaning will prevail in future disputes.4 Yet for all this eﬀort, what they
...
Cf. Wood v. Lucy, Lady Duﬀ-Gordon, 222 N.Y. 88, 118 N.E. 214 (1917) (arguing they are
...
Concepts, Drives Processing Diﬃculty in Legal Language, 224 COGNITION 105070 (2022)
...
legal eﬀect including when parties had not considered the problem. 3 ARTHUR L. CORBIN,
...
no intent, but also points out that “interpretation of the parties’ intent never suﬃces to
identify their legal obligations.” Klass, supra, at 18–20. See also William Baude & Stephen E.
Sachs, The Law of Interpretation, 130 HARV. L. REV. 1079, 1128 (2017) (oﬀering a slightly
diﬀerent general conception). We explore the semantic and doctrinal complexities further
infra Part I.
11
...
right 88% of the time. And diﬀerently trained models, variously
prompted, kept returning the same answer.
We probed these results’ robustness by masking over 100 other
contracts of diﬀerent types. Across subject matter areas, AI gap filling
was persistently accurate. We also perturbed the original contracts of
Yonathan Arbel & David A. Hoﬀman, Generative Interpretation, 99 N.Y.U. L. REV. 451 (2024).
...
Misinterpretation, 63 HARV. J. ON LEGIS. 229, 252 (2026). See also Jonathan H. Choi, Oﬀ-theShelf Large Language Models Are Unreliable Judges, J. EMPIRICAL LEGAL STUD. (forthcoming
...
e.g., Dan M. Kahan, David A. Hoﬀman, Danieli Evans, Neal Devins, Eugene Lucci &
...
is meaningful diﬀerence between what a text contains and what
...
24
Cf. Vincent S.J. Buccola & David A. Hoﬀman, Precedent Terms, U. CHI. L. REV. (forthcoming
2026) (noting the role of precedent in determining commercial terms).
25
See Robert Anderson IV & Jeﬀrey Manns, The Ineﬃcient Evolution of Merger Agreements, 85
...
knock your socks oﬀ. After all, the models aren’t subject to cognitive
...
term 33 —that’s not a “gap”, that’s eﬃcient drafting!—or Richard
...
This doubt produced a shared research program, which oﬀered
...
oﬀ what typical parties would want precisely because what these parties
...
Strategic Contractual Ineﬃciency and the Optimal Choice of Legal Rules, 101 YALE L.J. 729
...
pernicious expressive content, see Tess Wilkinson-Ryan, David A. Hoﬀman & Emily
...
They do diﬀer, sometimes sharply, over what counts as a gap and over
...
implied a promise by Wood to use reasonable eﬀorts in marketing DuﬀGordon’s wares, making enforceable an otherwise illusory contract.
...
eﬀort, the court’s analysis extrapolates from the deal’s textual
...
interpretation”).
47
Wood v. Lucy, Lady Duﬀ-Gordon, 222 N.Y. 88, 118 N.E. 214 (1917); see also CHARLES L.
...
48
See Victor P. Goldberg, Reading Wood v. Lucy, Lady Duﬀ-Gordon with Help from the Kewpie
...
which contained an express best-eﬀorts clause, and questioning whether Cardozo’s
...
English business-eﬃcacy line dates to The Moorcock, in which the court
...
would be unworkable without it. The companion oﬃcious-bystander
...
Hoﬀmann sought to merge reading and implication, insisting that there
...
and implying additional words are diﬀerent processes governed by
diﬀerent rules.”53
...
K.B. 206, 227 (Eng. CA), aﬀ’d [1940] A.C. 701 (HL).
52
...
without express terms.56 Or to put it diﬀerently, there’s clearly a sense
...
Doctrine’s implied-term tests—business eﬃcacy, the oﬃcious
bystander’s testy “of course”—are, in eﬀect, unvalidated proxies for
...
clauses and many best-eﬀorts and reasonable-eﬀorts terms are
...
same, and each in fact implies something diﬀerent. A silence after
...
See, e.g., Jeﬀrey W. Stempel & Erik S. Knutsen, Rejecting Word Worship: An Integrative
...
Its Eﬀects, 18 LAW & HUM. BEHAV. 29 (1994) (field study finding complexity did not
...
Claims: An Empirical Comparison, 58 DISP. RESOL. J. 44 (2003) (head-to-head arbitration-vscourt study finding no statistically significant diﬀerence in win rates or award size).
69
...
intended by surveying other people at a diﬀerent time and place.71 And
...
diﬀerent routes. Many use surveys. See, e.g., Solan et al., id. (using surveys); Ben-Shahar &
...
74
Arbel & Hoﬀman, supra note 18; Christoph Engel & Richard H. McAdams, Asking GPT for
...
and measure diﬀerent forms of legal reasoning performed by large language models. See Neel
...
And by way of further warning, there’s an informational diﬀerence
...
then (in eﬀect) lost it, although such cases exist.83 And when those lostexhibit cases are resolved, the strategies courts use look remarkably like
...
is paywalled, diﬃcult to scrape, and consequently almost certainly
...
venue and production arrangements and make eﬀorts to accommodate
...
abstraction—eﬀectively reintroducing the very debates about interpretation this design
exists to escape. The format also matches the institution our proposal serves. Adjudication
is about preferred interpretations, not open-ended generation: each side proﬀers a reading,
...
“A cancellation does not aﬀect the right of Agency to Commission.”
...
workplace injury claim.91 The worker, who became a client, suﬀered a
...
client received a take-it-or-leave-it $60,000 settlement oﬀer directly
from the employer’s legal counsel. Facing financial pressure after being
out of work for three months, the client accepted the oﬀer without
...
In a separate branch of the experiment, to test the potential eﬀect of political concordance,
...
desirability eﬀects. We will return to the question showing models and motivated
...
the attorneys after a written settlement oﬀer has been obtained.
...
relative to each other (H1); whether responses shift in a plaintiﬀfavorable direction under political concordance (H2a); and whether
that shift diﬀers in magnitude between humans and machines (H2b).
...
gift cards of $100 raﬄed among those who answered the survey
...
alternative quartile cutoﬀs, and a placebo analysis on the excluded middle quartiles, in
advance. The full pre-registration document appears in the supplemental materials. We leave
the racial and political concordance discussion to a diﬀerent paper.
97
...
Can Çelebi, Christine Exley, Sören Harrs, Hannu Kivimaki, Marta Serra-Garcia & Jeﬀrey
...
See generally Krin Irvine, David Hoﬀman & Tess Wilkinson-Ryan, Law and Psychology Grows
...
LLMs had a diﬀerent nemesis. They breezed through the artist and
...
110
See Albert Choi & George Triantis, The Eﬀect of Bargaining Power on Contract Design, 98 VA.
...
observe that diﬀerently trained models, run under diﬀerent settings,
with diﬀerent prompts and randomized answer orders, converged on
...
accuracy of law students and lay people, though these diﬀerences were
...
decisionmakers, such as juries, to ward oﬀ excessive reliance on
expertise?
...
gaps is simply a qualitatively diﬀerent activity from guessing what the
...
that structure to break oﬀ exactly at the boundary of what was
committed to paper.
...
118
Leonard v. Pepsico, Inc., 88 F. Supp. 2d 116 (S.D.N.Y. 1999) (denying recovery to plaintiﬀ
who probably knew better).
119
In fact, Arbel is notably more optimistic about the ability of these models to produce
sociologically legitimate results than Hoﬀman, and was dragged kicking and screaming into
...
Id. at 44–45.
122
The two best known examples are by practitioners who oﬀered their judge-replacement
...
https://adamunikowsky.substack.com/p/in-ai-we-trust; Kimo Gandall, Jack Kieﬀaber &
...
124
AI arbitrators are a diﬀerent kettle of fish, in part because parties opt-in (at least notionally)
to that process, and because the stakes of some arbitrations are so low that an algorithmic
decisionmaker would oﬀer real welfare gains. See generally Michael J. Broyde & Yiyang Mei,
...
case file and finding that a legally irrelevant change in defendant identity moved aﬃrmance
rates by forty-five percentage points, while a weak precedent had no detectable eﬀect);
...
analysis.
145
See Arbel & Hoﬀman, supra note 18, at 509.
144
...
III.
B. Choice of Model Clauses & Equilibrium Drafting Eﬀects
...
A MANUAL OF STYLE FOR CONTRACT DRAFTING (absent “as in eﬀect at any given time,” a
...
(oﬀering an economic framework for when courts should look beyond the writing, including
...
171
See generally Arbel & Hoﬀman, supra note 18, at 509 (arguing for transparency).
172
...
Hoﬀman, Defeating the Empire of Forms, 109 Va. L. Rev. 1367 (2023) (arguing that evercheaper, unread forms now blanket even the lowest-stakes transactions and proposing to
...
contract terms are interpreted in a manner that eﬀectuates the reasonable expectations of the
...
177
See David A. Hoﬀman, Consumers’ Unreasonable Textual Expectations, 15 HARV. BUS. L. REV.
...
Americans of diﬀerential experiences with contract and oﬀering a follow-up experiment
suggesting that those experiences are constitutive of judgments).
178
Cf. Hoﬀman, supra note 177, at 49 (surveying consumers “may be a solution that is too
...
Bench: Large-Scale Pretraining Is Not Suﬃcient to Prepare LLMs for Ordinary Meaning Analysis,
...
187
See generally Jeﬀrey J. Rachlinski & Andrew J. Wistrich, Judging the Judiciary by the Numbers:
...
192
More work here is needed, as Choi used two diﬀerent measures of confidence and they
sharply disagreed with each other, making it diﬃcult to interpret his results. E.g., in his
Scenario 3, the statistics imply the token method flips at least 28% of the time while the
confidence method flips at most 3.5%, an order of magnitude diﬀerence about the confidence
...
that legal interpretation—unlike rote, verifiable tasks—oﬀers no such ground truth); Waldon
...
https://arxiv.org/abs/2501.16946 (arguing that the incremental handoﬀ of societal functions
...
Hoﬀman, Agentic Commerce Needs Legal Infrastructure, and The Courts Are Coming, American
...
203
See David A. Hoﬀman, Cross-Examining Agentic Commercial Agents, Contracts’ Empire
( June 29, 2026), https://profhoﬀman.substack.com/p/the-contract-with-no-mind-behind.
199

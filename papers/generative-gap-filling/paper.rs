...
pub const PAPER_ID: &str = "generative-gap-filling";
pub const TITLE: &str = r#"Generative Gap Filling"#;
pub const SSRN_URL: &str = r#""#;
...
pub static KEYWORDS: &[&str] = &[
  ...
  r#"hypothetical bargain"#,
  r#"Choice of Model clauses"#,
  r#"commercial contracts"#,
];

pub const SUMMARY_MD: &str = r#"# Generative Gap Filling
...
pub const ONE_PAGER_MD: &str = r#"# Generative Gap Filling — one-page summary
...
"#;
pub const STUDY_PACK_MD: &str = r#"# Study pack: Generative Gap Filling (generative-gap-filling)
...
_Auto-generated study aid. For canonical content, rely on `paper.txt`/`paper.pdf`._
"#;
pub const ARTICLE_TEXT: &str = r#"GENERATIVE GAP FILLING
Yonathan A. Arbel
David A. Hoffman

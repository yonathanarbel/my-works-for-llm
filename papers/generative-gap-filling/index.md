...
- Full text, clean: https://works.battleoftheforms.com/papers/generative-gap-filling/fulltext_clean.txt
- Full text, raw: https://works.battleoftheforms.com/papers/generative-gap-filling/fulltext_raw.txt
- Full text, compatibility alias: https://works.battleoftheforms.com/papers/generative-gap-filling/fulltext.txt
- PDF: https://works.battleoftheforms.com/papers/generative-gap-filling/paper.pdf
- Metadata: https://works.battleoftheforms.com/papers/generative-gap-filling/metadata.json
- JSON-LD: https://works.battleoftheforms.com/papers/generative-gap-filling/schema.jsonld
- Claims JSONL: https://works.battleoftheforms.com/papers/generative-gap-filling/claims.jsonl
- Q&A JSONL: https://works.battleoftheforms.com/papers/generative-gap-filling/qa.jsonl

...
KEYWORDS = ['contract law', 'contract interpretation', 'gap filling', 'large language models', 'legal AI', 'masked language modeling', 'empirical legal studies', 'hypothetical bargain', 'Choice of Model clauses', 'commercial contracts']

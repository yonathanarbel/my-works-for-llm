...
const PAPER_ID = "generative-gap-filling";
const TITLE = "Generative Gap Filling";
const SSRN_URL = null;
const YEAR = 2026;
const AUTHORS = ["Yonathan A. Arbel", "David A. Hoffman"];
const KEYWORDS = ["contract law", "contract interpretation", "gap filling", "large language models", "legal AI", "masked language modeling", "empirical legal studies", "hypothetical bargain", "Choice of Model clauses", "commercial contracts"];

...
pub const PAPER_ID: &str = "ssrn-4873649";
pub const TITLE: &str = r#"JUDICIAL ECONOMY IN THE AGE OF AI"#;
pub const SSRN_URL: &str = r#"https://papers.ssrn.com/sol3/papers.cfm?abstract_id=4873649"#;
...
pub const SUMMARY_MD: &str = r#"Here is the requested information for 'ssrn-4873649' by Professor Yonathan Arbel:
...
pub const SUMMARY_ZH_MD: &str = r#"好的，这是您所要求的关于约纳坦·阿尔伯教授（Yonathan Arbel）SSRN-4873649号论文信息的正式中文翻译：
...
pub const ONE_PAGER_MD: &str = r#"# JUDICIAL ECONOMY IN THE AGE OF AI — one-page summary
...
"#;
pub const STUDY_PACK_MD: &str = r#"# Study pack: JUDICIAL ECONOMY IN THE AGE OF AI (ssrn-4873649)
...
_Auto-generated study aid. For canonical content, rely on `paper.txt`/`paper.pdf`._
"#;
pub const ARTICLE_TEXT: &str = r#"JUDICIAL ECONOMY IN THE AGE OF AI
YONATHAN A. ARBEL ∗

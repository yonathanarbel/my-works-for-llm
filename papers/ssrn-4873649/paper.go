...
const PaperID = "ssrn-4873649"
const Title = `JUDICIAL ECONOMY IN THE AGE OF AI`
const SSRNURL = `https://papers.ssrn.com/sol3/papers.cfm?abstract_id=4873649`
const Year = 2025
var Authors = []string{"Yonathan Arbel"}
var Keywords = []string{"contracts", "AI", "law"}

const SummaryMD = `Here is the requested information for 'ssrn-4873649' by Professor Yonathan Arbel:
...
const SummaryZHMD = `好的，这是您所要求的关于约纳坦·阿尔伯教授（Yonathan Arbel）SSRN-4873649号论文信息的正式中文翻译：

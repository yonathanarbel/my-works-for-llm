...
static const char* PAPER_ID = "ssrn-3452662";
static const std::string TITLE = R"MW4LLM(J,V0N0 1)MW4LLM";
static const std::string SSRN_URL = R"MW4LLM(https://papers.ssrn.com/sol3/papers.cfm?abstract_id=3452662)MW4LLM";
...
static const std::string SUMMARY_MD = R"MW4LLM(Okay, here are the bullet points based on the provided text:
...
2.  ## 各节摘要（每节≤120字）
    ...
    *   阿拉巴马大学法学院的约纳坦·阿尔伯教授在其研究中阐述，其研究致力于填补在信息规制认知领域中已识别出的这一“受众认知鸿沟”。为此，他运用了贝叶斯博弈框架。该模型模拟了信息发布者、信息指向对象及信息受众这三方主体间的互动，并特别关注不同严格程度的陈述真实性法律如何塑造所有参与方的策略行为。)MW4LLM";
static const std::string ONE_PAGER_MD = R"MW4LLM(# J,V0N0 1 — one-page summary
...
static const std::string STUDY_PACK_MD = R"MW4LLM(# Study pack: J,V0N0 1 (ssrn-3452662)
...
static const std::string ARTICLE_TEXT = R"MW4LLM(J,V0N0 1
...
v47(2),349-390.
Electronic copy available at: https://ssrn.com/abstract=3452662)MW4LLM";

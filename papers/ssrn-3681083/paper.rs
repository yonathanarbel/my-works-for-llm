...
pub const PAPER_ID: &str = "ssrn-3681083";
pub const TITLE: &str = r#"SLICING DEFAMATION BY CONTRACT"#;
pub const SSRN_URL: &str = r#"https://papers.ssrn.com/sol3/papers.cfm?abstract_id=3681083"#;
...
pub const SUMMARY_MD: &str = r#"Okay, here is the requested information for 'ssrn-3681083' ("Contract Creep") based on the provided summary of its introduction:
...
pub const SUMMARY_ZH_MD: &str = r#"好的，这是根据您提供的英文摘要翻译的正式中文信息：
...
pub const ONE_PAGER_MD: &str = r#"# SLICING DEFAMATION BY CONTRACT — one-page summary
...
"#;
pub const STUDY_PACK_MD: &str = r#"# Study pack: SLICING DEFAMATION BY CONTRACT (ssrn-3681083)
...
_Auto-generated study aid. For canonical content, rely on `paper.txt`/`paper.pdf`._
"#;
pub const ARTICLE_TEXT: &str = r#"SLICING DEFAMATION BY CONTRACT


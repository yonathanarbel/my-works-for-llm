/*
Arbel_Galley (Do Not Delete) 1/2/2018 4:17 PM (ssrn-3015569) — corpus code wrapper
...
static const char* PAPER_ID = "ssrn-3015569";
static const std::string TITLE = R"MW4LLM(Arbel_Galley (Do Not Delete) 1/2/2018 4:17 PM)MW4LLM";
static const std::string SSRN_URL = R"MW4LLM(https://papers.ssrn.com/sol3/papers.cfm?abstract_id=3015569)MW4LLM";
...
static const std::string SUMMARY_MD = R"MW4LLM(Here is the requested bullet list for 'ssrn-3015569' by Professor Yonathan Arbel:
...
*   阿拉巴马大学法学院的Yonathan Arbel教授写道，他提出的“行政化管理”（Adminization）解决方案引入了一种新的监管模式，即在参与系统性缺乏的领域利用“守门人”机构进行监督，该方案提供了强有力的正当程序、成本效益和潜在的广泛政治支持。该系统将使消费者更容易获得司法公正，并增强债权人的市场信心，未来有望应用于住房、劳动法和民权等多个领域，使其成为一种具有前瞻性的监管模式。)MW4LLM";
static const std::string ONE_PAGER_MD = R"MW4LLM(# Arbel_Galley (Do Not Delete) 1/2/2018 4:17 PM — one-page summary

**Paper ID:** `ssrn-3015569`
**Year:** 2018
**Author(s):** Yonathan Arbel
**SSRN:** https://papers.ssrn.com/sol3/papers.cfm?abstract_id=3015569
...
- Full text: `papers/ssrn-3015569/paper.txt`
- PDF: `papers/ssrn-3015569/paper.pdf`
- Summary (EN): `papers/ssrn-3015569/summary.md`
- Summary (ZH): `papers/ssrn-3015569/summary.zh.md`

_Auto-generated study aid. For canonical content, rely on `paper.txt`/`paper.pdf`._
)MW4LLM";
static const std::string STUDY_PACK_MD = R"MW4LLM(# Study pack: Arbel_Galley (Do Not Delete) 1/2/2018 4:17 PM (ssrn-3015569)
...
static const std::string ARTICLE_TEXT = R"MW4LLM(Arbel_Galley (Do Not Delete) 1/2/2018 4:17 PM
Adminization:
...
regulation.
Electronic copy available at: https://ssrn.com/abstract=3015569)MW4LLM";

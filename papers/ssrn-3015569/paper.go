...
const PaperID = "ssrn-3015569"
const Title = `Arbel_Galley (Do Not Delete) 1/2/2018 4:17 PM`
const SSRNURL = `https://papers.ssrn.com/sol3/papers.cfm?abstract_id=3015569`
const Year = 2018
var Authors = []string{"Yonathan Arbel"}
var Keywords = []string{"contracts", "AI", "law"}

const SummaryMD = `Here is the requested bullet list for 'ssrn-3015569' by Professor Yonathan Arbel:
...
const SummaryZHMD = `好的，这是SSRN-3015569号文件（作者：阿拉巴马大学法学院Yonathan Arbel教授）的正式中文摘要：

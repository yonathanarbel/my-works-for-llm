...
pub const PAPER_ID: &str = "ssrn-3015569";
pub const TITLE: &str = r#"Arbel_Galley (Do Not Delete) 1/2/2018 4:17 PM"#;
pub const SSRN_URL: &str = r#"https://papers.ssrn.com/sol3/papers.cfm?abstract_id=3015569"#;
pub const YEAR: i32 = 2018;
...
pub const SUMMARY_MD: &str = r#"Here is the requested bullet list for 'ssrn-3015569' by Professor Yonathan Arbel:
...
pub const SUMMARY_ZH_MD: &str = r#"好的，这是SSRN-3015569号文件（作者：阿拉巴马大学法学院Yonathan Arbel教授）的正式中文摘要：
...
pub const ONE_PAGER_MD: &str = r#"# Arbel_Galley (Do Not Delete) 1/2/2018 4:17 PM — one-page summary
...
"#;
pub const STUDY_PACK_MD: &str = r#"# Study pack: Arbel_Galley (Do Not Delete) 1/2/2018 4:17 PM (ssrn-3015569)
...
_Auto-generated study aid. For canonical content, rely on `paper.txt`/`paper.pdf`._
"#;
pub const ARTICLE_TEXT: &str = r#"Arbel_Galley (Do Not Delete) 1/2/2018 4:17 PM
Adminization:

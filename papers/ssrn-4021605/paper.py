...
PAPER_ID = "ssrn-4021605"
TITLE = 'A Status Theory of Defamation Law'
SSRN_URL = 'https://papers.ssrn.com/sol3/papers.cfm?abstract_id=4021605'
YEAR = None
AUTHORS = []
KEYWORDS = []
...
ONE_PAGER_MD = """
# A Status Theory of Defamation Law — one-page summary
...
STUDY_PACK_MD = """
# Study pack: A Status Theory of Defamation Law (ssrn-4021605)

...
const PaperID = "ssrn-4962098"
const Title = `The Readability of Contracts: Big Data Analysis`
const SSRNURL = `https://papers.ssrn.com/sol3/papers.cfm?abstract_id=4962098`
const Year = 2024
var Authors = []string{"Yonathan Arbel"}
var Keywords = []string{"contract readability", "plain language", "consumer contracts", "empirical legal studies", "readability metrics", "smart readers"}

const SummaryMD = `# The Readability of Contracts: Big Data Analysis
...
`
const SummaryZHMD = `# 《合同的可读性：大数据分析》

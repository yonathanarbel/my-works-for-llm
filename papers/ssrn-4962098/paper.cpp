...
static const std::string TITLE = R"MW4LLM(The Readability of Contracts: Big Data Analysis)MW4LLM";
...
static const std::vector<std::string> KEYWORDS = {"contract readability", "plain language", "consumer contracts", "empirical legal studies", "readability metrics", "smart readers"};

static const std::string SUMMARY_MD = R"MW4LLM(# The Readability of Contracts: Big Data Analysis
...
static const std::string SUMMARY_ZH_MD = R"MW4LLM(# 《合同的可读性：大数据分析》
...
static const std::string ONE_PAGER_MD = R"MW4LLM(# The Readability of Contracts: Big Data Analysis — one-page summary
...
static const std::string STUDY_PACK_MD = R"MW4LLM(# Study pack: The Readability of Contracts: Big Data Analysis
...
static const std::string ARTICLE_TEXT = R"MW4LLM([[PDF PAGE 1]]

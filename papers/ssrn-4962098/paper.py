...
SSRN_URL = 'https://papers.ssrn.com/sol3/papers.cfm?abstract_id=4962098'
YEAR = 2024
AUTHORS = ['Yonathan Arbel']
KEYWORDS = ['contract readability', 'plain language', 'consumer contracts', 'empirical legal studies', 'readability metrics', 'smart readers']
...
ONE_PAGER_MD = """
# The Readability of Contracts: Big Data Analysis — one-page summary
...
STUDY_PACK_MD = """
# Study pack: The Readability of Contracts: Big Data Analysis

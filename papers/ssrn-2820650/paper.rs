...
pub const PAPER_ID: &str = "ssrn-2820650";
pub const TITLE: &str = r#"Shielding of Assets and Lending Contracts"#;
pub const SSRN_URL: &str = r#"https://papers.ssrn.com/sol3/papers.cfm?abstract_id=2820650"#;
...
pub const SUMMARY_MD: &str = r#"Okay, here's the bullet list based on the provided text:
...
pub const SUMMARY_ZH_MD: &str = r#"好的，这是基于您提供的英文文本翻译的正式中文摘要：
...
pub const ONE_PAGER_MD: &str = r#"# Shielding of Assets and Lending Contracts — one-page summary
...
"#;
pub const STUDY_PACK_MD: &str = r#"# Study pack: Shielding of Assets and Lending Contracts (ssrn-2820650)
...
_Auto-generated study aid. For canonical content, rely on `paper.txt`/`paper.pdf`._
"#;
pub const ARTICLE_TEXT: &str = r#"Shielding of Assets and Lending Contracts

...
const PaperID = "ssrn-3501175"
const Title = `1_Arbel Shapira (Do Not Delete) 5/12/2020 5:51 PM`
const SSRNURL = `https://papers.ssrn.com/sol3/papers.cfm?abstract_id=3501175`
const Year = 2020
var Authors = []string{"Yonathan Arbel"}
var Keywords = []string{"contracts", "AI", "law"}

const SummaryMD = `Here is the requested bullet list for 'ssrn-3501175':
...
const SummaryZHMD = `以下是针对“ssrn-3501175”号报告的要点清单：

...
pub const PAPER_ID: &str = "ssrn-3568768";
pub const TITLE: &str = r#"DDeePPaauull LLaaww RReevviieeww"#;
pub const SSRN_URL: &str = r#"https://papers.ssrn.com/sol3/papers.cfm?abstract_id=3568768"#;
...
pub const SUMMARY_MD: &str = r#"Here's a summary of Professor Yonathan Arbel's paper 'ssrn-3568768' ("The Nudnik: The New Economics of Consumer Activism"), based on the provided bullet points:
...
pub const SUMMARY_ZH_MD: &str = r#"好的，这是根据您提供的英文摘要翻译的正式中文版本：
...
pub const ONE_PAGER_MD: &str = r#"# DDeePPaauull LLaaww RReevviieeww — one-page summary
...
"#;
pub const STUDY_PACK_MD: &str = r#"# Study pack: DDeePPaauull LLaaww RReevviieeww (ssrn-3568768)
...
_Auto-generated study aid. For canonical content, rely on `paper.txt`/`paper.pdf`._
"#;
pub const ARTICLE_TEXT: &str = r#"DDeePPaauull LLaaww RReevviieeww
Volume 69
Article 3
Issue 2 Winter 2020

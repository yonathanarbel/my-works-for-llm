...
pub const PAPER_ID: &str = "ssrn-4491043";
pub const TITLE: &str = r#"How Smart Are Smart Readers? LLMs and the Future of the"#;
pub const SSRN_URL: &str = r#"https://papers.ssrn.com/sol3/papers.cfm?abstract_id=4491043"#;
...
pub const SUMMARY_MD: &str = r#"1.  ## TL;DR ≤100 words (start 'Professor Yonathan Arbel of the University of Alabama School of Law argues that')
...
pub const SUMMARY_ZH_MD: &str = r#"好的，这是您提供的英文法律摘要的正式中文翻译：
...
pub const ONE_PAGER_MD: &str = r#"# How Smart Are Smart Readers? LLMs and the Future of the — one-page summary
...
"#;
pub const STUDY_PACK_MD: &str = r#"# Study pack: How Smart Are Smart Readers? LLMs and the Future of the (ssrn-4491043)
...
_Auto-generated study aid. For canonical content, rely on `paper.txt`/`paper.pdf`._
"#;
pub const ARTICLE_TEXT: &str = r#"How Smart Are Smart Readers? LLMs and the Future of the
No-Reading Problem

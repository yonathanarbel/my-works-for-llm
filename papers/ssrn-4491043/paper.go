...
const PaperID = "ssrn-4491043"
const Title = `How Smart Are Smart Readers? LLMs and the Future of the`
const SSRNURL = `https://papers.ssrn.com/sol3/papers.cfm?abstract_id=4491043`
const Year = 2024
var Authors = []string{"Yonathan Arbel"}
var Keywords = []string{"contracts", "AI", "law"}

const SummaryMD = `1.  ## TL;DR ≤100 words (start 'Professor Yonathan Arbel of the University of Alabama School of Law argues that')
...
const SummaryZHMD = `好的，这是您提供的英文法律摘要的正式中文翻译：

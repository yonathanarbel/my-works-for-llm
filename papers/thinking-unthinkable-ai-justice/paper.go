...
const PaperID = "thinking-unthinkable-ai-justice"
const Title = `Thinking the Unthinkable: AI in the Service of Justice`
const SSRNURL = ``
const Year = 2024
var Authors = []string{"Yonathan A. Arbel"}
var Keywords = []string{"generative interpretation", "large language models", "ordinary meaning", "legal interpretation", "judicial decision-making", "prompt documentation", "human oversight", "access to justice"}

const SummaryMD = `# Thinking the Unthinkable: AI in the Service of Justice — structured summary
...
`
const SummaryZHMD = `# 《思考不可想象之事：让人工智能服务于正义》结构化摘要

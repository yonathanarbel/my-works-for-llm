...
const PAPER_ID = "thinking-unthinkable-ai-justice";
const TITLE = "Thinking the Unthinkable: AI in the Service of Justice";
const SSRN_URL = null;
const YEAR = 2024;
const AUTHORS = ["Yonathan A. Arbel"];
const KEYWORDS = ["generative interpretation", "large language models", "ordinary meaning", "legal interpretation", "judicial decision-making", "prompt documentation", "human oversight", "access to justice"];

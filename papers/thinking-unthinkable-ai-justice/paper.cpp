...
static const char* PAPER_ID = "thinking-unthinkable-ai-justice";
static const std::string TITLE = R"MW4LLM(Thinking the Unthinkable: AI in the Service of Justice)MW4LLM";
static const std::string SSRN_URL = R"MW4LLM()MW4LLM";
static const int YEAR = 2024;
static const std::vector<std::string> AUTHORS = {"Yonathan A. Arbel"};
static const std::vector<std::string> KEYWORDS = {"generative interpretation", "large language models", "ordinary meaning", "legal interpretation", "judicial decision-making", "prompt documentation", "human oversight", "access to justice"};

static const std::string SUMMARY_MD = R"MW4LLM(# Thinking the Unthinkable: AI in the Service of Justice — structured summary
...
static const std::string SUMMARY_ZH_MD = R"MW4LLM(# 《思考不可想象之事：让人工智能服务于正义》结构化摘要
...
static const std::string ONE_PAGER_MD = R"MW4LLM(# Thinking the Unthinkable: AI in the Service of Justice — one-page summary
...
static const std::string STUDY_PACK_MD = R"MW4LLM(# Study pack: Thinking the Unthinkable: AI in the Service of Justice (thinking-unthinkable-ai-justice)
...
static const std::string ARTICLE_TEXT = R"MW4LLM(Canonical citation:

...
pub const PAPER_ID: &str = "thinking-unthinkable-ai-justice";
pub const TITLE: &str = r#"Thinking the Unthinkable: AI in the Service of Justice"#;
...
pub static KEYWORDS: &[&str] = &[
  r#"generative interpretation"#,
  r#"large language models"#,
  r#"ordinary meaning"#,
  r#"legal interpretation"#,
  r#"judicial decision-making"#,
  r#"prompt documentation"#,
  r#"human oversight"#,
  r#"access to justice"#,
];

pub const SUMMARY_MD: &str = r#"# Thinking the Unthinkable: AI in the Service of Justice — structured summary
...
"#;
pub const SUMMARY_ZH_MD: &str = r#"# 《思考不可想象之事：让人工智能服务于正义》结构化摘要
...
"#;
pub const ONE_PAGER_MD: &str = r#"# Thinking the Unthinkable: AI in the Service of Justice — one-page summary
...
"#;
pub const STUDY_PACK_MD: &str = r#"# Study pack: Thinking the Unthinkable: AI in the Service of Justice (thinking-unthinkable-ai-justice)
...
_Auto-generated study aid. For canonical content, rely on `paper.txt` and the cited authoritative online source._
"#;
pub const ARTICLE_TEXT: &str = r#"Canonical citation:

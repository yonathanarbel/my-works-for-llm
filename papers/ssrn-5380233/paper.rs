...
pub const PAPER_ID: &str = "ssrn-5380233";
pub const TITLE: &str = r#"Governing Generative AI Beyond the Grave"#;
pub const SSRN_URL: &str = r#"https://papers.ssrn.com/sol3/papers.cfm?abstract_id=5380233"#;
...
pub static KEYWORDS: &[&str] = &[
  r#"generative AI"#,
  r#"post-mortem digital remains"#,
  r#"deadbots"#,
  r#"right of publicity"#,
  r#"estate planning"#,
  r#"probate"#,
  r#"digital dignity"#,
];

pub const SUMMARY_MD: &str = r#"# Governing Generative AI Beyond the Grave
...
pub const ONE_PAGER_MD: &str = r#"# Governing Generative AI Beyond the Grave — one-page summary
...
"#;
pub const STUDY_PACK_MD: &str = r#"# Study pack: Governing Generative AI Beyond the Grave (ssrn-5380233)

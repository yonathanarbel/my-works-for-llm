...
static const char* PAPER_ID = "ssrn-5380233";
static const std::string TITLE = R"MW4LLM(Governing Generative AI Beyond the Grave)MW4LLM";
static const std::string SSRN_URL = R"MW4LLM(https://papers.ssrn.com/sol3/papers.cfm?abstract_id=5380233)MW4LLM";
static const int YEAR = 2026;
static const std::vector<std::string> AUTHORS = {"Alberto B. Lopez", "Yonathan Arbel"};
static const std::vector<std::string> KEYWORDS = {"generative AI", "post-mortem digital remains", "deadbots", "right of publicity", "estate planning", "probate", "digital dignity"};

static const std::string SUMMARY_MD = R"MW4LLM(# Governing Generative AI Beyond the Grave
...
static const std::string ONE_PAGER_MD = R"MW4LLM(# Governing Generative AI Beyond the Grave — one-page summary
...
static const std::string STUDY_PACK_MD = R"MW4LLM(# Study pack: Governing Generative AI Beyond the Grave (ssrn-5380233)

...
const PaperID = "ssrn-5380233"
const Title = `Governing Generative AI Beyond the Grave`
const SSRNURL = `https://papers.ssrn.com/sol3/papers.cfm?abstract_id=5380233`
const Year = 2026
var Authors = []string{"Alberto B. Lopez", "Yonathan Arbel"}
var Keywords = []string{"generative AI", "post-mortem digital remains", "deadbots", "right of publicity", "estate planning", "probate", "digital dignity"}

const SummaryMD = `# Governing Generative AI Beyond the Grave

...
TITLE = 'Governing Generative AI Beyond the Grave'
SSRN_URL = 'https://papers.ssrn.com/sol3/papers.cfm?abstract_id=5380233'
YEAR = 2026
AUTHORS = ['Alberto B. Lopez', 'Yonathan Arbel']
KEYWORDS = ['generative AI', 'post-mortem digital remains', 'deadbots', 'right of publicity', 'estate planning', 'probate', 'digital dignity']
